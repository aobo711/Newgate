...
public class NewsServices {
    ...
    private static final String TAG = NewsServices.class.getSimpleName();
    private LinkedList<News> newsList;
    private SwipeRefreshLayout mRefreshLayout;
    private CustomCardListAdapter adapter;
    private Context context;

    public NewsServices(){}

    public NewsServices(Context context, LinkedList<News> newsLis, SwipeRefreshLayout mRefreshLayout, CustomCardListAdapter adapter){
    ...
    public NewsServices(Context context, LinkedList<News> newsLis, CustomCardListAdapter adapter){
        this.newsList = newsLis;
        this.adapter = adapter;
        this.context = context;
        this.sp = PreferenceManager.getDefaultSharedPreferences(context);
